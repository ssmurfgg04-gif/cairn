...
Human-gated (next): push + tag `v1.0.0`, then the release workflow publishes `cairn-windows-v1.0.0.exe` and the installer gate runs automatically; then the actual hour of human beta use per BETA.md §6.
